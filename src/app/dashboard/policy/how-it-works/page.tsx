...
export default function HowItWorksManagerPage() {
  ...
  useEffect(() => {
    fetch(`${BACKEND}/api/admin/pages/how-it-works`, {
  ...
  async function handleSave() {
    ...
    setSaveMsg(null)
    try {
      const res = await fetch(`${BACKEND}/api/admin/pages/how-it-works`, {
        method: 'POST',
        headers: {
      ...
      setSaveMsg({ text: 'How It Works page saved successfully.', ok: true })
    } catch (err) {
  ...
  return (
    <div className="dash-page">
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 16 }}>
        <div>
          <h2 style={{ fontSize: 20, fontWeight: 600, color: '#1a1a2e', margin: 0 }}>How It Works Manager</h2>
          <p style={{ color: 'rgba(0,0,0,0.4)', fontSize: 14, marginTop: 4 }}>
            Edit the content displayed on <strong>/how-it-works</strong>.
